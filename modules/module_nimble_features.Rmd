...
# Lifted nodes: implications for updating model quantities
...
Whoops, *y* was simulated based on the value of the lifted node, which was not updated based on the new value of *tau*. That's why *y* is close to its mean of zero even though *tau* is very small. 
...
... still thinking of what would be good here ...
