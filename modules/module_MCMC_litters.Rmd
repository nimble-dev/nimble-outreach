...
smp_cross <- as.matrix(Cmcmc$mvSamples[postBurn, ])
...
Here we use Nimble's alternative parameterizations to directly represent the beta distribution in terms of mean and standard deviation. For some reason, the L-BFGS-B optimization method was not working well here, so we make use of the Nelder-Mead optimization algorithm.
...
mcemReparam <- buildMCEM(modelReparam, latentNodes = 'p', burnIn = 500, optimControl = list(
            method='Nelder-Mead'))
print(system.time(
