...
# if this isn't done, registerDistributions fails to find dmyexp
...
# if this isn't done, registerDistributions fails to find ddirchmulti
...
We can now rewrite the topic model as follows. We won't apply this to a real dataset but one could now use this rewritten model in an algorithm such as MCMC, as in the first exercise.
