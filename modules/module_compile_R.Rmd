...
So we get a nice 5-fold speedup, even though all of the R code was vectorized. In the first exercise, you'll consider an example of replacing an explicit for loop in R.
