...
*Exercise*: run the MCMC with multiple chains and judge convergence based on the Gelman-Rubin diagnostic.

*Exercise*: try blocking the hyperparameters for each group, following the syntax in the previous model. See if that improves mixing. 
