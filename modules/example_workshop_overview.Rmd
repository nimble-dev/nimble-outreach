...
* File bug reports or feature requests as [https://github.com/nimble-dev](Github issues).
...
* Develop an algorithm using NIMBLE and either share it with us (e.g., by a Git pull request or more informall) or develop an R package that depends on NIMBLE.
